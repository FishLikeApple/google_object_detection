# conloss3 e0-60+0-60*4
mode = 'training'
#mode = 'generating'
#mode = 'debug_test'
#mode = 'test'

generating_start_num = 0
dataset_code = 2
...
def main(_):
    ...
    total_training_iters = 0

    if dataset_code == 1:
        parts_per_dataset = 15
        random_seed = 21
        sampling_record_path = main_path + 'sub_train/data_sampling_records/'
    elif dataset_code == 2:
        parts_per_dataset = 3
        random_seed = 1745
        ...
        parts_per_dataset = 3
        random_seed = 1113918
        sampling_record_path = main_path + 'sub_train/data_sampling_records3/'
            ...
            for j in range(parts_per_dataset):
                ...
                if mode == 'training':
                    os.system('python '+mmdetection_path+'tools/train.py '+main_path+'code/'+config_file+\
                        ' --gpus 1 --work_dir '+output_path+' --past_iteration '+str((i*parts_per_dataset)+j+1)+\
